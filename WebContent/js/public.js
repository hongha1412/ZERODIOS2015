...
function logoimg(jz){
	if (jz==undefined || jz=="pc") {
		document.write("<a href='http://zerodios.com/' target='_blank' title='ZeroDios'><img src='./images/logo.png'/></a>")
	} else if (jz=="pad") {
		document.write("<a href='http://zerodios.com/' target='_blank' title='ZeroDios'><img src='./images/logo.png'/></a>");
	} else if (jz=="jsz") {
		document.write("<a href='http://zerodios.com/' target='_blank' title='ZeroDios'><img src='./images/jzSaviorLogo.png'/></a>");
	}
}

function tongji(){
	document.write("<script src='./js/c.php?id=30072404' language='JavaScript'><\/script>")
}
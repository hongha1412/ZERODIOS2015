...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .background-color {
      background-color: rgba(7, 12, 18, 1) !important;
    }
    ...
    .secondary-text-color {
      color: rgba(154, 139, 240, 1) !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="buttons-container">
		<a class="border-button" href="http://localhost" target="_blank">Go To Homepage</a>
		<a class="border-button" href="mailto:sullie456@gmail.com" target="_blank">Report A Problem</a>
	</div>
</div>

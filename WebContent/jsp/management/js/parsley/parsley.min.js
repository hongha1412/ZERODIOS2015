...
/*
 * To force custom show error, example:
 * <input type="email" id="email" name="[controlName]" placeholder="test@example.com" data-required="true" data-type="email"
 * 
 * $("#email").parsley().options.messages["ZDMessage-[controlName]"] = "Test Email Message";
...
! function(d) {
    ...
    j.prototype = {
        ...
        init: function(a, b) {
            ...
            this.$element = d(a);
            this.val = this.$element.attr("id") === "editor" ? this.$element.val() : this.$element.html();
            this.isRequired = !1;
            this.constraints = {};
        ...
        getVal: function() {
            return this.$element.attr("id") === "editor" ? this.$element.text() : (this.$element.data("value") || this.$element.val())
        ...
        validate: function(a, custom = "") {
            ...
            if (custom !== "") {
                ("undefined" !== typeof a ? a : this.options.showErrors) && this.manageValidationResult(custom);
                return false;
            } else {
        ...
        manageValidationResult: function(custom = "") {
            var a = null,
                b;
            for (b in this.constraints) {
                if (custom !== "") {
                    this.manageError(this.constraints[b], custom);
                    this.errorClassHandler.addClass(this.options.errorClass);
                    break
                }
        ...
        manageError: function(a, custom = "") {
            ...
            if (!("required" === a.name && null !== this.getVal() && 0 < this.getVal().length) && (!this.isRequired || !("required" !== a.name && (null === this.getVal() || 0 === this.getVal().length)))) {
                ...
                a = !1 !== this.options.errorMessage ? this.options.errorMessage : "type" === a.name ? this.Validator.messages[b][a.requirements] : "undefined" === typeof this.Validator.messages[b] ? this.Validator.messages.defaultMessage : this.Validator.formatMesssage(this.Validator.messages[b],
                    a.requirements);
                if (custom !== "") {
                    a = this.options.messages["ZDMessage-" + custom];
                }
    ...
    l.prototype = {
        ...
        getVal: function() {
            if (this.$element.attr("id") === "editor") return this.$element.text();
    ...
    k.prototype = {
        ...
        validate: function(a, custom = "") {
            ...
            for (var c = 0; c < this.items.length; c++) {
                if (custom !== "") {
                    if (this.items[c].element[0].name === custom) {
                        if ("undefined" !== typeof this.items[c] &&
                                !1 === this.items[c].validate(undefined, custom) && (b = !1, !this.focusedField && "first" === this.options.focus || "last" === this.options.focus)) {
    ...
    d.fn.parsley.defaults = {
        inputs: "input, textarea, select, div[id=editor]",
